...
public class Manager {
    ...
    public void applyShaderToPlayer(Player player, Season season) {
        ...
        switch (season) {
            case XUAN -> player.addPotionEffect(new PotionEffect(
                    PotionEffectType.NIGHT_VISION,
                    Integer.MAX_VALUE, 0, false, false, false
            ));
            case HA -> player.addPotionEffect(new PotionEffect(
                    PotionEffectType.NIGHT_VISION,
                    Integer.MAX_VALUE, 1, false, false, false
            ));
            case THU -> player.addPotionEffect(new PotionEffect(
                    PotionEffectType.HUNGER,
                    Integer.MAX_VALUE, 0, false, false, false
            ));
            case DONG -> player.addPotionEffect(new PotionEffect(
